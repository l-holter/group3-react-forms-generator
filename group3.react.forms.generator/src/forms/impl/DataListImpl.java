 ...
 * </p>
 * <ul>
 *   <li>{@link forms.impl.DataListImpl#getOption <em>Option</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataListImpl extends FormElementImpl implements DataList {
	/**
	...
	protected EClass eStaticClass() {
		return FormsPackage.Literals.DATA_LIST;
	}
	...
	public EList<Option> getOption() {
		if (option == null) {
			option = new EObjectContainmentEList<Option>(Option.class, this, FormsPackage.DATA_LIST__OPTION);
		}
		return option;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FormsPackage.DATA_LIST__OPTION:
