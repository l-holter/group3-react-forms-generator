...
public class FormsFactoryImpl extends EFactoryImpl implements FormsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case FormsPackage.FORM_GROUP: return createFormGroup();
			case FormsPackage.LABEL: return createLabel();
			case FormsPackage.FORM: return createForm();
			case FormsPackage.INPUT: return createInput();
			case FormsPackage.ATTRIBUTE: return createAttribute();
			case FormsPackage.TEXT_AREA: return createTextArea();
			case FormsPackage.SELECT: return createSelect();
			case FormsPackage.OPTION: return createOption();
			case FormsPackage.BUTTON: return createButton();
			case FormsPackage.DATA_LIST: return createDataList();
			case FormsPackage.OPTION_GROUP: return createOptionGroup();
			default:
