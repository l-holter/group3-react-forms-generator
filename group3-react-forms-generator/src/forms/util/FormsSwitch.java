...
public class FormsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FormsPackage.OPTION: {
				Option option = (Option)theEObject;
				T result = caseOption(option);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FormsPackage.BUTTON: {
			...
			case FormsPackage.DATA_LIST: {
				DataList dataList = (DataList)theEObject;
				T result = caseDataList(dataList);
				if (result == null) result = caseFormElement(dataList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FormsPackage.OPTION_GROUP: {
				OptionGroup optionGroup = (OptionGroup)theEObject;
				T result = caseOptionGroup(optionGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Option Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Option Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOptionGroup(OptionGroup object) {
		return null;
	}
